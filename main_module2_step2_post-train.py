...
save_dir_format = os.path.join(root_dir, 'pt_10-Ks_{}_company_masking_first={}', '{}')
...
if __name__ == '__main__':
    ...
    for post_filepath in post_filepaths:
        for masking_mode, is_masking_company_name_first in [('with', True), ('with', False), ('wo', None)]:
            ...
            save_dir = save_dir_format.format(masking_mode, is_masking_company_name_first, data_mode)
